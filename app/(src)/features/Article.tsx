    ...
    <Card className="w-full max-w-sm mx-auto  rounded-xl ">
      <CardContent className="p-0">
        ...
        <div className="p-4 max-sm:flex max-sm:flex-col flex-wrap ">
          <h3 className="text-lg font-semibold py-1">{props.name}</h3>
          <p className="text-sm text-gray-500 py-1 flex">{props.color}</p>
          <div className="flex items-center justify-between">
            <span className="font-meduim">${props.price}</span>
          </div>
        </div>
      </CardContent>
    </Card>
